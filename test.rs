...
//// Authenticate the username and password within a module
mod authentication {
...
//// Test: count the letters and numbers of an input string within a module which has several sub-modules
mod text_processing {
